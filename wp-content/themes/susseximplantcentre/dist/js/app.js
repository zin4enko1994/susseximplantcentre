...
$(function () {
  ...
  function openServiceInfo() {
    $('.accordion-wrapper .item').on('click', function (e) {
      e.preventDefault(); // $('.content').removeClass('open');
  ...
  scrollToSection();
  sendMail();
  firstWorld(); // $(window).resize(hoverTeamBlock);
});
...
__webpack_require__(/*! /Users/zinchenko/dev/susseximplantcentre/wp-content/themes/susseximplantcentre/src/js/app.js */"./src/js/app.js");
module.exports = __webpack_require__(/*! /Users/zinchenko/dev/susseximplantcentre/wp-content/themes/susseximplantcentre/src/scss/app.scss */"./src/scss/app.scss");
